...
{
    /// <summary>
    /// Class used only in the TASandbox to test animations.
    /// </summary>
    public class SandboxSceneSequences : MonoBehaviour
    {
        public BlockMotions stackOntoBeltTile;
        public Transform ontoStackPoint;
        public string motionName; 
        
        [Header("Cascade 1")]
        public BlockMotions beltOntoBoardTile;
        [Space(10)]
        public BlockMotions[] cascadingRightTiles;

        [Header("Cascade 2")]
        public BlockMotions beltOntoBoardTile2;
        [Space(10)]
        public BlockMotions[] cascadingRightTiles2;
        
        [Header("Cascade 3")]
        public BlockMotions beltOntoBoardTile3;
        [Space(10)]
        public BlockMotions[] cascadingRightTiles3;
        
        [Header("Cascade 4")]
        public BlockMotions beltOntoBoardTile4;
        [Space(10)]
        public BlockMotions[] cascadingRightTiles4;
        ...
        private void DoCascade(BlockMotions initiator, BlockMotions[] tiles, int cascade)
        {
